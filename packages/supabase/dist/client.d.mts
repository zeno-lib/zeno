 ...
 */
declare function createClient<Database>(/** Supabase project URL. */

supabaseUrl: string, /** Supabase API key. */
 ...
 */
declare function createAnonClient<Database>(/** Supabase project URL. Defaults to `SUPABASE_URL`, then `NEXT_PUBLIC_SUPABASE_URL`. */

supabaseUrl?: string, /** Supabase publishable key. Defaults to `SUPABASE_PUBLISHABLE_KEY`, then `NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY`. */
 ...
 */
declare function createAdminClient<Database>(/** Supabase project URL. Defaults to `SUPABASE_URL`, then `NEXT_PUBLIC_SUPABASE_URL`. */

supabaseUrl?: string, /** Supabase secret key. Defaults to `SUPABASE_SECRET_KEY`. */
