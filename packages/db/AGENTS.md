...
- **The update-side audit columns are owned by triggers, not by Drizzle.**
  ...
  snapshot links into the chain so `drizzle-kit migrate` tracks it. Verified
